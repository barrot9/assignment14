...
final_project: main.o macro_Handling.o macro_validation.o line_recognizer.o file_generator.o utils.o
	gcc -g -ansi -pedantic -Wall main.o macro_Handling.o macro_validation.o line_recognizer.o file_generator.o utils.o -o final_project

main.o: main.c main.h macro_Handling.h macro_validation.h line_recognizer.h file_generator.h utils.h
...
clean:
	rm -f final_project main.o macro_Handling.o macro_validation.o line_recognizer.o utils.o file_generator.o
