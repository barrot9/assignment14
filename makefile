...
final_project: main.o macro_Handling.o macro_validation.o line_recognizer.o file_generator.o utils.o line_validator.o firstStage.o secondStage.o
	gcc -g -ansi -pedantic -Wall main.o macro_Handling.o macro_validation.o line_recognizer.o file_generator.o utils.o line_validator.o firstStage.o secondStage.o -o final_project

main.o: main.c main.h stages/preProcessor/macro_Handling.h stages/preProcessor/macro_validation.h stages/lineAnalyzer/line_recognizer.h stages/finalStage/file_generator.h stages/utils/utils.h stages/lineAnalyzer/line_validator.h
